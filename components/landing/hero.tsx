...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-purple-600 via-purple-500 to-purple-400" />
        ...
        <div className="mx-auto max-w-6xl">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/15 border border-white/20 mb-8">
              ...
              <span className="text-sm text-white/90">Coming Soon to iOS</span>
            </div>

            {/* Headline */}
            <h1
              className="text-4xl md:text-6xl lg:text-7xl text-white tracking-tight max-w-4xl text-balance"
            ...
            {/* User type toggle */}
            <div className="mt-10 inline-flex rounded-full bg-white/15 border border-white/20 p-1">
              <button
                type="button"
            ...
            {userType === 'student' ? (
                ...
                {!submitted ? (
                  ...
                  >
                    <input
                      ...
                      required
                      className="flex-1 h-12 px-4 rounded-lg bg-white border-0 text-gray-900 placeholder:text-gray-400 text-sm outline-none focus:ring-2 focus:ring-white/30 transition"
                    />
                    <button
                      type="submit"
                      className="h-12 px-6 rounded-lg bg-purple-900 text-white text-sm font-medium hover:bg-purple-950 transition-colors inline-flex items-center gap-2 whitespace-nowrap"
                      disabled={submitting}
                    >
                  ...
                  <div className="mt-6 flex items-center gap-2 px-6 py-4 rounded-xl bg-white/15 border border-white/20">
              ...
              <div className="mt-6">
                <Link
                  href="/apply"
                  className="inline-flex items-center gap-2 h-12 px-8 rounded-lg bg-white text-purple-700 text-sm font-medium hover:bg-white/90 transition-colors"
                >
            ...
            <div className="mt-16 flex justify-center">
              <div className="relative">
                {/* iPhone frame */}
                <div className="relative w-[260px] h-[520px] rounded-[2.5rem] bg-foreground p-2.5 shadow-2xl shadow-black/30">
                  {/* Dynamic Island */}
                ...
                {/* Glow */}
                <div className="absolute -inset-4 bg-white/10 rounded-[4rem] blur-2xl -z-10" />
              </div>
            </div>
