        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-16 flex justify-center">
            <div className="relative">
              {/* iPhone frame */}
              <div className="relative w-[280px] md:w-[320px] rounded-[3rem] bg-foreground p-3 shadow-2xl shadow-foreground/20">
                {/* Dynamic Island */}
                <div className="absolute top-4 left-1/2 -translate-x-1/2 w-24 h-7 bg-foreground rounded-full z-10" />

                {/* Screen */}
                <div className="relative rounded-[2.25rem] overflow-hidden bg-card">
                  {/* Status bar */}
